CREATE TABLE basic_information ( 
        protein_id BIGINT GENERATED ALWAYS AS IDENTITY primary key,  -- 即 index，自增主键
...
CREATE TABLE substrate ( 
        protein_id BIGINT primary key,  -- 即 index，关联 basic_information 表的 protein_id
